...
export default function Home() {
  return (
    <div className="min-h-screen bg-[url('/images/headerbackground.jpg')] bg-cover bg-center">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center min-h-[80vh] from-gray-100 to-plum-100 py-16 ">
        {/* Top SVG Border */}
        ...
        <div className="text-center py-8 px-4">
          ...
          <div className="mt-8 flex justify-center">
            <a
              href="#rsvp"
              className="bg-burgundy text-gray-800 px-8 py-3 rounded-full hover:bg-plum-800 transition-colors shadow-lg shadow-plum-200/40"
            >
              RSVP Now
            </a>
          </div>
      ...
      <section className="py-20 bg-[#611729]">
        <div className="max-w-4xl mx-auto px-4 bg-gray-300 bg-opacity-50 rounded-lg p-8">
      ...
      <section id="rsvp" className="py-20 bg-plum-50">
        <div className="max-w-2xl mx-auto px-4 bg-gray-300 bg-opacity-50 rounded-lg p-8 border-2 border-[#8E4585]">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-1/2 mx-auto flex justify-center bg-burgundy text-black font-semibold py-3 rounded-lg hover:bg-plum-800 transition-colors bg-[#8E4585]"
            >
              Submit RSVP
            </button>
          </form>
